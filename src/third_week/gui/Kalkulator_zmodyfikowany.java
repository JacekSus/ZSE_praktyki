...
public class Kalkulator_zmodyfikowany extends JFrame{
    ...
    private JButton przyciskpomnóż;
    ...
    public Kalkulator_zmodyfikowany(){
        ...
        przyciskpomnóż=new JButton("pomnóż");
        przyciskpodziel=new JButton("podziel");
        przyciskpotęga=new JButton("potęga");
        add(panelLiczb);
        ...
        panelFunkcji.add(przyciskpomnóż);
        panelFunkcji.add(przyciskpodziel);
        panelFunkcji.add(przyciskpotęga);
        add(panelWyniku);
        ...
        przyciskpomnóż.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                double a = Double.parseDouble(poleLiczbaA.getText());
                double b = Double.parseDouble(poleLiczbaB.getText());
        ...
        przyciskpotęga.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                double a = Double.parseDouble(poleLiczbaA.getText());
                double b = Double.parseDouble(poleLiczbaB.getText());
                double c = round(a * a, 2);
                double d = round(b * b, 2);
                wynik.setText("A=" + c +" B="+d);
            }
        });
    ...
    public static void main(String[] args) {
        Kalkulator_zmodyfikowany calc = new Kalkulator_zmodyfikowany();
    }
